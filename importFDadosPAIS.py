...
with conn.cursor() as cursor:
    for index, row in df.iterrows():
        id_pais = row['id']  # Coluna 'id' no arquivo Excel
        nome_pais = row['pais']  # Coluna 'nomePais' no arquivo Excel
        
        # Comando SQL para inserir dados na tabela
        inserir_dados = f"INSERT INTO pais (id, nomePais) VALUES ({id_pais}, '{nome_pais}')"
